...
MODEL_XML_PATH = os.path.join(fr"D:\Research\ICCSSE\ParalllelCableDrivenRobot\SpaceRobotEnv\assets", "ParallelCableDrivenRobot_v1.xml")


class ParallelCableDrivenRobot_v11(gym.Env):
    ...
    def _get_reward(self, current_info, action):
        ...
        # reward of 0518 v11-run17
        reward = -2*distance - 0.5*np.log(distance + 1e-6)
